// Generated on 2015-07-16 using generator-ionic-slash 0.0.1
'use strict';
    ...
    tags: {
        buildJs: {
            options: {
                ...
                openTag: '<!-- your app\'s js -->',
                closeTag: '<!-- your app\'s css -->'
            },
            src: [
        ...
        buildCss: {
            options: {
                ...
                openTag: '<!-- your app\'s css -->',
                closeTag: ' <!-- build:js scripts/scripts.js -->'
            },
            src: [
                '<%= yeoman.app %>/sections/**/*.css'
            ],
            dest: '<%= yeoman.app %>/index.html'
        }
    },
